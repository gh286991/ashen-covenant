...
Every audio asset currently used by Ashen Covenant is licensed **CC0 1.0
Universal** (public domain). Attribution is not required, but the sources are
recorded here for transparency and future maintenance.

| Files in this project | Source | Creator | License |
| --- | --- | --- | --- |
| `music/ancient_caverns.ogg` | [Ancient caverns (horror ambient loop)](https://opengameart.org/content/ancient-caverns-horror-ambient-loop) | congusbongus | CC0 1.0 |
| `music/boss_battle.ogg` | [RPG Battle Theme II](https://opengameart.org/content/rpg-battle-theme-ii) | CleytonKauffman | CC0 1.0 |
